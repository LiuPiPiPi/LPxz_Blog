<template>
  <header ref="header">
    <div class="view">
      <img
        ref="imgbg1"
        src="https://lpxz.oss-cn-zhangjiakou.aliyuncs.com/wallhaven-kwqqkq_1920x1080.png"
        style="display: none"
      />
      <div
        class="bg1"
        style="
          background-image: url('https://lpxz.oss-cn-zhangjiakou.aliyuncs.com/wallhaven-kwqqkq_1920x1080.png');
        "
      ></div>
      <div
        class="bg2"
        style="
          background-image: url('https://lpxz.oss-cn-zhangjiakou.aliyuncs.com/wallhaven-dp6q7l_1920x1080.png');
        "
      ></div>
      <div
        class="bg3"
        style="
          background-image: url('https://lpxz.oss-cn-zhangjiakou.aliyuncs.com/wallhaven-9mxz8k_1920x1080.png');
        "
        v-show="loaded"
      ></div>
    </div>
    <div class="text-malfunction" data-word="LPxz's Blog">
      <div class="line"></div>
    </div>
    <div class="wrapper">
